...
APPLICATION_IP_ADDRESS = ENV['APPLICATION_IP_ADDRESS'] || '127.0.0.1'

# domain for the API
API_DOMAIN = ENV['API_DOMAIN'] || 'http://127.0.0.1:3000/'

# get api key from HTTP headers if this value is present
HTTP_HEADER_API_KEY_NAME = ENV['HTTP_HEADER_API_KEY_NAME'] || 'THINGSPEAKAPIKEY'
...
RESET_PASSWORD_URL = ENV['RESET_PASSWORD_URL'] || 'http://127.0.0.1:3000//users/reset_password/'
